        ...
        // 担当者のマスターデータ
        const ownerMaster = {
            "営業": ["専務", "銭", "麻生", "原田", "岡本", "津村", "前川", "池田", "展久", "陳"],
            "設計": ["藤山", "田中(善)", "安岡", "川邊", "檀", "堀井", "宮﨑", "津田", "古村", "柴田", "橋本", "松本(英)", "立野"],
            "製管": ["製造管理", "資材"],
            "組立": ["米澤", "桂", "香西", "古賀", "長谷川", "早川", "廣田", "宮本", "山下", "センティル", "小林", "外注"],
            "電装": ["木村(至)", "木村(圭)", "守時", "外注"],
            "品証": ["田中(孝)"],
        ...
        const taskNameOptions = [
            ...
            { label: "出荷", options: ["出荷準備", "出荷準備(組立)", "出荷準備(電装)", "梱包出荷", "工場出荷"] }
        ];
