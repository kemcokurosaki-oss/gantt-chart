    ...
    function _buildHtml(rd) {
        ...
        rows.forEach(function(r) {
            ...
            if (r.sd && r.ed && r.type === 'task') {
                ...
                else                           bCls += ' ' + (MAJOR_COLOR[r.majorItem] || 'ubar-other');
